...
function successMsg(msg) {
    showMsg(msg, {icon: 1, time: 2000});
}

/** 显示失败消息 */
function failMsg(msg) {
    showMsg(msg, {icon: 2, time: 2000});
}

/** layui 确认窗口 **/
function layui_comfirm(title, funCalback) {
    layer.open({
        content: title + '?'
        , btn: ['确认', '取消']
...
/*关闭弹出框口 table里点开的窗口，关闭并刷新table*/
function table_layer_close() {
    /*setTimeout(function () {
